...
public:
    ...
    cwcreator(int lines, int columns, std::string infile): Board(lines,columns), Dictionary(infile){};
    ...
    */
	bool addWord(std::string position, std::string word);
    ...
    */
    bool helpWord(std::string position);
...
private:
    ...
    * @param possiblewords
    */
    void wildcardWords(std::string word, std::vector<std::string> &possiblewords);
